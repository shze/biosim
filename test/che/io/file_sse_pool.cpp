...
BOOST_AUTO_TEST_CASE(file_sse_pool_read) {
  ...
  BOOST_CHECK(a.get_molecule("A").get_ss().get_sequence()[0].get_identifier_char() == 'H');
  BOOST_CHECK(a.get_molecule("A").get_ss().get_sses().size() == 20);
  ...
  BOOST_CHECK(a2.get_molecule("A").get_ps().size() == 163);
  BOOST_CHECK(a2.get_molecule("A").get_ps()[0].get_identifier_char() == 'M');
  BOOST_CHECK(a2.get_molecule("A").get_ss().defined());
  BOOST_CHECK(a2.get_molecule("A").get_ss().get_sequence().size() == 163);
  BOOST_CHECK(a2.get_molecule("A").get_ss().get_sequence()[0].get_identifier_char() == 'H');
  BOOST_CHECK(a2.get_molecule("A").get_ss().get_sses().size() == 17);
  ...
  BOOST_CHECK(a2.get_molecule("A").get_ps().size() == 195);
  BOOST_CHECK(a2.get_molecule("A").get_ps()[0].get_identifier_char() == 'M');
  BOOST_CHECK(a2.get_molecule("A").get_ss().defined());
  BOOST_CHECK(a2.get_molecule("A").get_ss().get_sequence().size() == 195);
  BOOST_CHECK(a2.get_molecule("A").get_ss().get_sequence()[0].get_identifier_char() == 'H');
  BOOST_CHECK(a2.get_molecule("A").get_ss().get_sses().size() == 17);
  ...
  BOOST_CHECK(a.get_molecule("A").get_ps().size() == 49);
  BOOST_CHECK(a.get_molecule("A").get_ps()[3].get_identifier_char() == 'X');
  BOOST_CHECK(a.get_molecule("A").get_ss().defined());
  BOOST_CHECK(a.get_molecule("A").get_ss().get_sequence().size() == 49);
  ...
  BOOST_CHECK(a.get_molecule("B").get_ps().size() == 49);
  BOOST_CHECK(a.get_molecule("B").get_ps()[3].get_identifier_char() == 'X');
  BOOST_CHECK(a.get_molecule("B").get_ss().defined());
  BOOST_CHECK(a.get_molecule("B").get_ss().get_sequence().size() == 49);
  BOOST_CHECK(a.get_molecule("B").get_ss().get_sequence()[3].get_identifier_char() == 'H');
  BOOST_CHECK(a.get_molecule("B").get_ss().get_sses().size() == 3);
  ...
  BOOST_CHECK(a.get_molecule("A").get_ps().size() == 60);
  BOOST_CHECK(a.get_molecule("A").get_ps()[13].get_identifier_char() == 'X');
  BOOST_CHECK(a.get_molecule("A").get_ss().defined());
  BOOST_CHECK(a.get_molecule("A").get_ss().get_sequence().size() == 60);
  BOOST_CHECK(a.get_molecule("A").get_ss().get_sequence()[13].get_identifier_char() == 'H');
  BOOST_CHECK(a.get_molecule("A").get_ss().get_sses().size() == 3);
