...
BOOST_AUTO_TEST_CASE(file_assembly_read) {
  ...
  BOOST_CHECK(a.get_first_structure("A").get_length() == 76);
  ...
  BOOST_CHECK(a.get_first_structure("B").get_length() == 76);
  ...
  BOOST_CHECK(a.get_first_structure("A").get_ss().get_sses().size() == 17);
  ...
  BOOST_CHECK(a.get_first_structure("A").get_ss().get_sequence().size() == 195);
  BOOST_CHECK(a.get_first_structure("A").get_ss().get_sequence()[3].get_identifier_char() == 'E');
  BOOST_CHECK(a.get_first_structure("A").get_ss().get_sses().size() == 13);
  ...
  BOOST_CHECK(a.get_first_structure("B").get_ps()[14].get_identifier_char() == 'X');
  BOOST_CHECK(a.get_first_structure("B").get_ss().defined());
  BOOST_CHECK(a.get_first_structure("B").get_ss().get_sequence().size() == 49);
  BOOST_CHECK(a.get_first_structure("B").get_ss().get_sequence()[14].get_identifier_char() == 'H');
